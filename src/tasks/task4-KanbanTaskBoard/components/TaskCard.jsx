    ...
    <Draggable draggableId={task.id} index={index}>
      {(provided) => (
        <div
          ...
          className="group p-3.5 rounded-xl hover:bg-slate-50 border border-slate-300 hover:border-slate-200 transition-all duration-150 cursor-grab active:cursor-grabbing shadow-sm bg-white"
        >
